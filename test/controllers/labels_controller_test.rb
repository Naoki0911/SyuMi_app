...
class LabelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create label" do
    assert_difference('Label.count') do
      post labels_url, params: { label: { feature: @label.feature, sake_id: @label.sake_id } }
    end
  ...
  test "should update label" do
    patch label_url(@label), params: { label: { feature: @label.feature, sake_id: @label.sake_id } }
